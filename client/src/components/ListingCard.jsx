...
export default function ListingCard({ listing }) {
  return (
    <div className="bg-white shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden rounded-lg widh-full sm:w-[330px]">
      <Link to={`/listing/${listing._id}`}>
        ...
        <div className="p-3 flex flex-col gap-2 w-full">
          ...
          <p className="text-slate-500 mt-2 font-semibold flex items-center">
            ${' '}
            {listing.offer ? listing.discountPrice.toLocaleString('pl-PL') : listing.regularPrice.toLocaleString('pl-PL')}
