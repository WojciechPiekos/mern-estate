...
export default function UpdateListing() {
  ...
  useEffect(() => {
    const fetchListing = async (idListing) => {
    console.log(idListing)
        try {
            const res = await fetch(`/api/listing/get/${idListing}`)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLoading(true);
      setError(false);
      const res = await fetch(`/api/listing/update/${idListing}`, {
        method: "POST",
        headers: {
